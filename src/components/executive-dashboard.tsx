...
const topMetrics = [
  ...
  },
  {
    ...
    info: "Sprint 7 delivered 56 completed story points versus the Sprint 1 baseline of 40, a 40% increase. DASH-8 and DASH-14 were delivered using GitHub Copilot, while the team also benefited from reusable patterns and better sequencing.",
    tone: "purple",
    icon: "team",
...
const flowMetrics = [
  {
    name: "Flow Velocity",
    description: "Completed story points per sprint (COUNT)",
    baseline: "95",
    baselineUnit: "story points/sprint",
    after: "145",
    afterUnit: "story points/sprint",
    change: "+53%",
    direction: "up",
    tone: "blue",
...
const periodSnapshots = {
  "12": {
    ...
    flow: {
      "Flow Velocity": { baseline: "40", after: "56", change: "+40%", direction: "up", points: "0,18 18,12 36,19 54,9 72,13 90,2 108,7 126,-3 144,2 162,-7 180,-2 198,-14" },
